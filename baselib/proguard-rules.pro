...
# in L:\Android\sdk1/tools/proguard/proguard-android.txt
...
-keep public class * implements com.jess.arms.integration.ConfigModule
 ...
 #实体类不参与混淆
-keep class com.jni_text.jyl.ailock.mvp.model.entity.**{*;}
-keep class com.jni_text.jyl.ailock.mybean.**{*;}
-keep class com.jni_text.jyl.ailock.myview.** { *; } #自定义控件不参与混淆
-keep class com.jni_text.jyl.ailock.mvp.ui.widget.** { *; } #自定义控件不参与混淆
